...
// e107 Plugin Admin Area — githubFind (mode: themesources) — "Find Theme Sources".
// Self-contained entry script: the sources UI classes (github_themesources_ui /
// github_sources_form_ui) live inline below, with marketType 'theme'. Manages the
// 'find_theme_sources' preference (theme catalogs: sources/themes/*.xml + remote URLs).
...
class github_themesources_ui extends e_admin_ui
{
