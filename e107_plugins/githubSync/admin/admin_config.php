...
// e107 Plugin Admin Area — githubSync (mode: main)
// Thin entry script: shares the dispatcher from admin_menu.php, defines the
// UI + form classes for mode 'main', and delegates all sync work to the
// github_sync_engine handler. No sync logic lives here.
...
class github_sync_ui extends e_admin_ui
{
	...
	public function renderHelp()
	{
		return array(
			'caption' => LAN_HELP,
			'text'    => 'This plugin is tested and used for the e107 2.x.x Lite version. Use it at your own risk.',
		);
	}
...
class github_sync_form_ui extends e_admin_form_ui
{
	...
	function options($parms, $value, $id, $attributes)
	{
		...
		$query2    = array('action' => 'sync', 'id' => $id);
